...
namespace IntegrationTest.DataProviders
{
    public class GenericDataProviderTest
    {
        ...
        {
            _dataProvider = new DataProvider<TicketType>(new ApplicationDbContext(DataProviderRequirements.GetDbContextOptions()), DataProviderRequirements.GetAutoMapper());
            _applicationDbContext = new ApplicationDbContext(DataProviderRequirements.GetDbContextOptions());
            _dbSet = _applicationDbContext.Set<TicketType>();
            _mapper = DataProviderRequirements.GetAutoMapper();
        }
