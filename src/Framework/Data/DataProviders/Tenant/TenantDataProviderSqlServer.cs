...
{
    public class TenantDataProviderSqlServer : DataProvider<Tenant>, ITenantDataProvider
    {
        #region Ctor

        public TenantDataProviderSqlServer(ApplicationDbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
