...
namespace Data.DataProviders
{
    public interface ITeamDataProvider : IDataProvider<Team>
    {
        ...
        /// <summary>
        /// Get the child teams of given team in all levels.
        /// </summary>
        /// <param name="rootTeamId">Id of the rootTeam.</param>
        /// <returns>Return IList of Team entity
        /// that contains the child teams of given team in all levels.
        /// </returns>
        IList<Team> GetChildTeam(int rootTeamId);

        /// <summary>
        /// Get the child teams of given team in all levels that mapped to TDto.
        /// </summary>
        /// <typeparam name="TDto">TDto is a destination type of mapping process that its source type is TEntity.</typeparam>
        /// <param name="rootTeamId">Id of the rootTeam.</param>
        /// <returns>Return IList of Team entity
        /// that contains the child teams of given team in all levels that mapped to TDto.
        /// </returns>
        IList<TDto> GetChildTeam<TDto>(int rootTeamId) where TDto : class, IListViewModel;

        /// <summary>
        /// Get the root team of given team in highest level in hierarchy.
        /// </summary>
        /// <param name="childTeamId">Id of child team for finding its root team.</param>
        /// <returns>Return the root Team entity of given team in highest level in hierarchy.
        /// </returns>
        Team GetRootTeam(int childTeamId);

        /// <summary>
        /// Get the root team of given team in highest level in hierarchy that mapped to TDto.
        /// </summary>
        /// <typeparam name="TDto">TDto is a destination type of mapping process that its source type is TEntity.</typeparam>
        /// <param name="childTeamId">Id of child team for finding its root team.</param>
        /// <returns>Return the root Team entity of given team in highest level in hierarchy that mapped to TDto.
        /// </returns>
        TDto GetRootTeam<TDto>(int childTeamId) where TDto : class, IViewModel;

        /// <summary>
        /// Find the root team from user team in highest level in hierarchy.
        /// </summary>
        /// <param name="userId">Id of user for finding root team in highest level in hierarchy from user team.</param>
        /// <returns>Return the root Team entity from user team in highest level in hierarchy.
        /// </returns>
        Team GetRootTeamByUser(int userId);

        /// <summary>
        /// Find the root team user team in highest level in hierarchy that mapped to TDto.
        /// </summary>
        /// <typeparam name="TDto">TDto is a destination type of mapping process that its source type is TEntity.</typeparam>
        /// <param name="userId">Id of user for finding root team in highest level in hierarchy from user team.</param>
        /// <returns>Return the root Team entity from user team in highest level in hierarchy that mapped to TDto.
        /// </returns>
        TDto GetRootTeamByUser<TDto>(int userId) where TDto : class, IViewModel;
