...
{
    public class TeamDataProviderPostgres : DataProvider<Team>, ITeamDataProvider
    {
        #region Ctor

        public TeamDataProviderPostgres(ApplicationDbContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
