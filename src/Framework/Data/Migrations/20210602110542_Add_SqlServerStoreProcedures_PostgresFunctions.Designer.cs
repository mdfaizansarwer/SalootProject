...
namespace Data.Migrations
{
    ...
    [Migration("20210602110542_Add_SqlServerStoreProcedures_PostgresFunctions")]
    partial class Add_SqlServerStoreProcedures_PostgresFunctions
    {
            ...
            modelBuilder.Entity("Data.Entities.ActionsLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        ...
                        .HasDefaultValue(new DateTime(2021, 6, 2, 15, 35, 42, 653, DateTimeKind.Local).AddTicks(5976));
            ...
            modelBuilder.Entity("Data.Entities.Files.FileModel", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 2, 15, 35, 42, 654, DateTimeKind.Local).AddTicks(5605));
            ...
            modelBuilder.Entity("Data.Entities.Identity.Tenant", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 2, 15, 35, 42, 654, DateTimeKind.Local).AddTicks(3981));
            ...
            modelBuilder.Entity("Data.Entities.Logging.EmailsLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 2, 15, 35, 42, 654, DateTimeKind.Local).AddTicks(827));
            ...
            modelBuilder.Entity("Data.Entities.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 2, 15, 35, 42, 650, DateTimeKind.Local).AddTicks(5394));
            ...
            modelBuilder.Entity("Data.Entities.Team", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 2, 15, 35, 42, 653, DateTimeKind.Local).AddTicks(6594));
            ...
            modelBuilder.Entity("Data.Entities.Ticket", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 2, 15, 35, 42, 653, DateTimeKind.Local).AddTicks(7587));
            ...
            modelBuilder.Entity("Data.Entities.TicketProcess", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 2, 15, 35, 42, 653, DateTimeKind.Local).AddTicks(8875));
            ...
            modelBuilder.Entity("Data.Entities.TicketType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 2, 15, 35, 42, 654, DateTimeKind.Local).AddTicks(353));
            ...
            modelBuilder.Entity("Data.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 2, 15, 35, 42, 653, DateTimeKind.Local).AddTicks(3457));
            ...
            modelBuilder.Entity("Data.Entities.UserRole", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 2, 15, 35, 42, 653, DateTimeKind.Local).AddTicks(4999));
