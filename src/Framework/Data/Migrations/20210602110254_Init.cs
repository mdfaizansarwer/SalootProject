        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            if (ActiveProvider == "Npgsql.EntityFrameworkCore.PostgreSQL")
            {
                ...
                columns: table => new
                {
                    ...
                    controller_name = table.Column<string>(type: "character varying(15)", maxLength: 15, nullable: true),
                    action_name = table.Column<string>(type: "character varying(15)", maxLength: 15, nullable: true),
                    http_method = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    action_arguments = table.Column<string>(type: "text", nullable: true),
                    request_path = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    api_result_status_code = table.Column<byte>(type: "smallint", nullable: false),
                    is_canceled = table.Column<bool>(type: "boolean", nullable: false),
                    created_on = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 30, 36, 240, DateTimeKind.Local).AddTicks(7582))
                },
            constraints: table =>
            {
                table.PrimaryKey("pk_actions_log", x => x.id);
            });
                ...
                migrationBuilder.CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        created_on = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 30, 36, 238, DateTimeKind.Local).AddTicks(2099)),
                ...
                migrationBuilder.CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        created_on = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 30, 36, 241, DateTimeKind.Local).AddTicks(7259)),
                ...
                migrationBuilder.CreateTable(
                    ...
                    columns: table => new
                    {
                        id = table.Column<int>(type: "integer", nullable: false)
                            .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                        name = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                        created_on = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 30, 36, 241, DateTimeKind.Local).AddTicks(5808))
                    },
                    constraints: table =>
                    {
                ...
                migrationBuilder.CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        created_on = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 30, 36, 241, DateTimeKind.Local).AddTicks(1972))
                    },
                    constraints: table =>
                    {
                ...
                migrationBuilder.CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        created_on = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 30, 36, 240, DateTimeKind.Local).AddTicks(8241))
                    },
                    constraints: table =>
                    {
                ...
                migrationBuilder.CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        refresh_token_expiration_time = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                        team_id = table.Column<int>(type: "integer", nullable: false),
                        profile_picture_id = table.Column<int>(type: "integer", nullable: true),
                        created_on = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 30, 36, 240, DateTimeKind.Local).AddTicks(5141)),
                ...
                migrationBuilder.CreateTable(
                    ...
                    columns: table => new
                    {
                        user_id = table.Column<int>(type: "integer", nullable: false),
                        role_id = table.Column<int>(type: "integer", nullable: false),
                        created_on = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 30, 36, 240, DateTimeKind.Local).AddTicks(6645))
                    },
                    constraints: table =>
                    {
                ...
                migrationBuilder.CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        created_on = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 30, 36, 241, DateTimeKind.Local).AddTicks(2418))
                    },
                    constraints: table =>
                    {
                ...
                migrationBuilder.CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        created_on = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 30, 36, 240, DateTimeKind.Local).AddTicks(9252))
                    },
                    constraints: table =>
                    {
                ...
                migrationBuilder.CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        created_on = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 30, 36, 241, DateTimeKind.Local).AddTicks(525))
                    },
                    constraints: table =>
                    {
            ...
            if (ActiveProvider == "Microsoft.EntityFrameworkCore.SqlServer")
            {
                migrationBuilder.CreateTable(
                   ...
                   columns: table => new
                   {
                       ...
                       ControllerName = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                       ActionName = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                       ...
                       ApiResultStatusCode = table.Column<byte>(type: "tinyint", nullable: false),
                       IsCanceled = table.Column<bool>(type: "bit", nullable: false),
                       CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 32, 54, 238, DateTimeKind.Local).AddTicks(7214))
                   },
                   constraints: table =>
                   {
                       table.PrimaryKey("PK_ActionsLog", x => x.Id);
                   });
                ...
                migrationBuilder.CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 32, 54, 235, DateTimeKind.Local).AddTicks(5618)),
                ...
                migrationBuilder.CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 32, 54, 239, DateTimeKind.Local).AddTicks(5468)),
                ...
                migrationBuilder.CreateTable(
                    ...
                    columns: table => new
                    {
                        Id = table.Column<int>(type: "int", nullable: false)
                            .Annotation("SqlServer:Identity", "1, 1"),
                        Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                        CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 32, 54, 239, DateTimeKind.Local).AddTicks(3878))
                    },
                    constraints: table =>
                    {
                        table.PrimaryKey("PK_Tenant", x => x.Id);
                ...
                migrationBuilder.CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 32, 54, 239, DateTimeKind.Local).AddTicks(1768))
                    },
                    constraints: table =>
                    {
                ...
                migrationBuilder.CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 32, 54, 238, DateTimeKind.Local).AddTicks(7870))
                    },
                    constraints: table =>
                    {
                        table.PrimaryKey("PK_Team", x => x.Id);
                        table.CheckConstraint("CHK_Tenant", "((ParentId IS NULL AND TenantId IS NOT NULL) OR (TenantId IS NULL AND ParentId IS NOT NULL))");
                        table.ForeignKey(
                ...
                migrationBuilder.CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 32, 54, 238, DateTimeKind.Local).AddTicks(4739)),
                ...
                migrationBuilder.CreateTable(
                    ...
                    columns: table => new
                    {
                        UserId = table.Column<int>(type: "int", nullable: false),
                        RoleId = table.Column<int>(type: "int", nullable: false),
                        CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 32, 54, 238, DateTimeKind.Local).AddTicks(6254))
                    },
                    constraints: table =>
                    {
                ...
                migrationBuilder.CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 32, 54, 239, DateTimeKind.Local).AddTicks(2209))
                    },
                    constraints: table =>
                    {
                        table.PrimaryKey("PK_EmailsLog", x => x.Id);
                        table.CheckConstraint("CHK_EmailsLog", "((ToUserId IS NULL AND ToEmail IS NOT NULL) OR (ToEmail IS NULL AND ToUserId IS NOT NULL))");
                        table.ForeignKey(
                ...
                migrationBuilder.CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 32, 54, 238, DateTimeKind.Local).AddTicks(8867))
                    },
                    constraints: table =>
                    {
                        table.PrimaryKey("PK_Ticket", x => x.Id);
                ...
                migrationBuilder.CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 6, 2, 15, 32, 54, 239, DateTimeKind.Local).AddTicks(247))
                    },
                    constraints: table =>
                    {
